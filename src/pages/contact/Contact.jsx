...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
        .send ('service_yapkgda', 'template_l96n3gw', formData, 'cs97jk2iR9jNl3OhN' ).then(
          () => {
          ...
          (error) => {
          alert('OOPs! SOMEETHING WENT WRONG...', error)
          },
        );
            ...
            <div className="contact-content grid">
                ...
                <div className="contact-card">
                    ...
                    <div>
                        ...
                        <p className="contact-data">Dakar, Medina SENEGAL</p>
                ...
                <div className="contact-card">
                    ...
                    <div>
                        ...
                        <p className="contact-data">Disponible dès maintenant</p>
                ...
                <div className="contact-card">
                    ...
                    <div>
                        ...
                        <p className="contact-data">ousmanendiaye.sn19@gmail.com</p>
                ...
                <div className="contact-card">
                    ...
                    <div>
                        ...
                        <p className="contact-data">+221 77 960 58 25</p>
